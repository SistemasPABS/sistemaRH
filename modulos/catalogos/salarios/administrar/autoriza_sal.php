...
session_start();
$usid=$_SESSION['us_id'];
$salid= base64_decode($_POST['sal']);  

//echo 'valor a eliminar: '.$idpersona;
include '../../../../config/conectasql.php';
$autoriza = new conectasql();
$autoriza->abre_conexion("0");
$autoriza->consulta_sal($salid);
//si ya fue autorizado el salario se mandara mensaje avisando que esta autorizado
if($autoriza->consulta['sal_aprovado'] == 1){
    echo 'El salario ha sido autorizado previamente';
}else{
    $autoriza->autoriza_salario($usid,$salid);
