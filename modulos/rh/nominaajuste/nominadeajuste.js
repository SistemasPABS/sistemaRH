function traerpercepcionesdeducciones(opc,btn){
    ...
    var url = "../sobrerecibo/evaluador.php";
     $.ajax({
             type: "POST",
             url:url,
 ...
 function enviarnominadeajuste(){
    if(confirm('En este momento se generará el registro de tu nomina de ajuste') == true){
      ...
      var cantidadpersonas = document.getElementsByName("persona[]");
        ...
        document.todalanominadeajuste.submit();
