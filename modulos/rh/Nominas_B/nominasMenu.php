    ...
    echo '<div id="modal-container">';
        echo '<div class="modal-background">';
            echo '<div class="modal">';
                ...
                echo '</div>';
                echo '<div class="row">';
                    echo '<input class="btn_opc" type="button" name="nuevo" id="one" value="Nomina de Cobranza"  onclick="popup(\'Cobranza/index.php\',\''. base64_encode($this->em).'\',\''. base64_encode('cobranza').'\');" > ';
                echo '</div>';    
                echo '<div class="row">';
                    echo '<input class="btn_opc" type="button" name="nuevo" id="one" value="Nomina de Ventas"  onclick="popup(\'Ventas/index.php\',\''. base64_encode($this->em).'\',\''. base64_encode('ventas').'\');" > ';
                echo '</div>';  
                echo '<div class="row">';
                    echo '<input class="btn_opc" type="button" name="nuevo" id="one" value="Nomina de Funeraria"  onclick="popup(\'Funeraria/index.php\',\''. base64_encode($this->em).'\',\''. base64_encode('funeraria').'\');" > ';
                echo '</div>';  
                echo '<div class="row">';
                    echo '<input class="btn_opc" type="button" name="nuevo" id="one" value="Nomina de Administartivos"  onclick="popup(\'Administracion/index.php\',\''. base64_encode($this->em).'\',\''. base64_encode('adminin').'\');" > ';
                echo '</div>';  
            echo '</div>';
        echo '</div>';
    echo '</div>';
