...
class nominaC extends sqlad {
    ...
    echo '<form method="post" id="form_nominaCob" name="form_nominaCob" action="importaXls.php" enctype="multipart/form-data">';
                       
         /*Modal Seleccion de Nomina*/
        echo '<div id="modal" class="modal2">';
        echo '<div id="modal-content" class="modal-content">';
                echo '<div class="row">';
                    echo '<label class="titulo_1" >Selecciona Detalles de Nomina</label></br>';
                echo '</div>';
                echo '<div class="row">';
