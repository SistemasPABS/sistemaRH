...
include('../../../config/conectasql.php');
    ...
    class creareportesrh extends conectasql{
        protected $usid;
        protected $em;
    ...
    public function librerias() {
        echo '<script type="text/javascript" src="lanzaderareportesrh.js"></script>';
                ...
                <div class="row">
                    <div class="panel panel-default">
                        ...
                        <table class="table table-fixed">
                            ...
                            <tbody>
                                <tr>
                                    <td class="col-xs-2">1</td><td class="col-xs-8">Reporte rendimientos</td><td><input type="button" id="idreporte" name="idreporte" onclick=window_open() value="Exportar"></input></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
